...
OBJECTS= src/bsdf.o src/bvh.o src/bxdf.o src/camera.o src/fresnel.o src/intersection.o src/io.o src/math.o src/microfacet.o src/onb_math.o src/path.o src/primitive.o src/random.o src/ray.o src/render.o src/shape.o src/texture.o src/lodepng/lodepng.o
