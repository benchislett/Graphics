...
OBJECTS= ./src/bsdf.o ./src/bvh.o ./src/bxdf.o ./src/camera.o ./src/intersection.o ./src/io.o ./src/math.o ./src/path.o ./src/primitive.o ./src/ray.o ./src/render.o ./src/shape.o
