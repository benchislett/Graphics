...
Vec3::Vec3() { e[0] = 0.f; e[1] = 0.f; e[2] = 0.f; }
Vec3::Vec3(float w) { e[0] = w; e[1] = w; e[2] = w; }
...
bool Vec3::operator==(const Vec3 &v) const { return e[0] == v.e[0] && e[1] == v.e[1] && e[2] == v.e[2]; }
bool Vec3::operator!=(const Vec3 &v) const { return e[0] != v.e[0] || e[1] != v.e[1] || e[2] != v.e[2]; }
...
float length(const Vec3 &v) { return sqrtf(length_sq(v)); }
